...
pub const PARALLAX_SETS = [_]ParallaxSet {
    ...
    .{ // Halo
        ...
        .images = &[_]ParallaxImage{
            ...
            ParallaxImage.init("/images/HALO/parallax/3-mountain-far.png", 0.05),
            ...
            ParallaxImage.init("/images/HALO/parallax/7-cloud-ring-back.png", 0.24),
            ParallaxImage.init("/images/HALO/parallax/8-pods-front.png", 0.3),
            ParallaxImage.init("/images/HALO/parallax/9-clouds-ring-front1.png", 0.4),
            ParallaxImage.init("/images/HALO/parallax/10-clouds-ring-front2.png", 0.4),
            ParallaxImage.init("/images/HALO/parallax/11-glow1.png", 0.0),
            ParallaxImage.init("/images/HALO/parallax/12-mountain-near.png", 0.35),
            ParallaxImage.init("/images/HALO/parallax/13-glow2.png", 0.0),
            ParallaxImage.init("/images/HALO/parallax/14-clouds-front.png", 0.4),
            ParallaxImage.init("/images/HALO/parallax/15-masterchief.png", 1.2),
        },
    },
    .{ // Thanos
        .bgColor = .{
